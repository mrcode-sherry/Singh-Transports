...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen bg-gray-200 flex items-center">
      <div className="md:px-24 mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-10">
        {/* Text Content */}
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
            ...
            <Link href="/contact">
            <button className="bg-transparent border-2 border-yellow-500 text-blue-900 font-semibold px-6 py-3 rounded-lg hover:bg-yellow-500 hover:text-blue-900 transition-all cursor-pointer duration-300">
              Contact Us
            </button>
            </Link>
          </div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <div className="w-full max-w-sm h-64 bg-blue-100 rounded-xl flex items-center justify-center shadow-lg">
            <span className="text-blue-400 font-bold">Your Vehicle Image Here</span>
          </div>
        </motion.div>
      </div>
    </section>
